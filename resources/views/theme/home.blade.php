			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
					<div class="product-item-sm d-flex">
						<div class="thumbnail">
							<img src="{{ asset('site') }}/images/product-1.png" alt="Image" class="img-fluid">
						</div>
						<div class="pt-3">
							<h3>Nordic Chair</h3>
				...
				<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
					<div class="product-item-sm d-flex">
						<div class="thumbnail">
							<img src="{{ asset('site') }}/images/product-2.png" alt="Image" class="img-fluid">
						</div>
						<div class="pt-3">
				...
				<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
					<div class="product-item-sm d-flex">
						<div class="thumbnail">
							<img src="{{ asset('site') }}/images/product-3.png" alt="Image" class="img-fluid">
						</div>
						<div class="pt-3">
